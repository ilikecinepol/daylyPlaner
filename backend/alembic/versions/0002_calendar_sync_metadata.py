...
def upgrade():
    ...
    op.add_column("calendar_connections",sa.Column("status",sa.String(30),nullable=False,server_default="connected"))
    ...
    op.create_index("ix_external_calendar_events_connection","external_calendar_events",["calendar_connection_id"])
