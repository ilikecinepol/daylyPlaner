...
class TaskIn(BaseModel):
    title:str=Field(min_length=1,max_length=500); description:str=""; priority:str=Field(default="P3",pattern="^P[1-4]$"); status:str=Field(default="planned",pattern="^(idea|planned|in_progress|completed)$"); project_id:str|None=None; column_id:str|None=None; assigned_to_id:str|None=None; start_at:datetime|None=None; due_at:datetime|None=None; duration_minutes:int=Field(default=60,ge=0,le=10080); all_day:bool=False; location:str=""; tags:list[str]=[]; mentions:list[str]=[]; recurrence_rule:str=""; reminder_offsets:list[int]=[]
class TaskPatch(BaseModel):
    model_config=ConfigDict(extra="forbid")
    title:str|None=Field(default=None,min_length=1,max_length=500); description:str|None=None; priority:str|None=Field(default=None,pattern="^P[1-4]$"); status:str|None=Field(default=None,pattern="^(idea|planned|in_progress|completed)$"); project_id:str|None=None; column_id:str|None=None; assigned_to_id:str|None=None; start_at:datetime|None=None; due_at:datetime|None=None; duration_minutes:int|None=Field(default=None,ge=0,le=10080); all_day:bool|None=None; location:str|None=None; tags:list[str]|None=None; mentions:list[str]|None=None; recurrence_rule:str|None=None; reminder_offsets:list[int]|None=None; sync_version:int|None=None
