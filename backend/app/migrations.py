...
SQLITE_COLUMNS={
 ...
 "projects":{"updated_at":"DATETIME","deleted_at":"DATETIME","team_label":"VARCHAR(100) DEFAULT ''","priority":"VARCHAR(2) DEFAULT 'P3'","budget_amount":"NUMERIC(18,2)","budget_currency":"VARCHAR(3)"},
...
SQLITE_COLUMNS["goals"]={"target_amount":"NUMERIC(18,2)","currency":"VARCHAR(3)"}
