...
class Task(Base, TimestampMixin):
    ...
    date: Mapped[str] = mapped_column(String(10), default=""); time: Mapped[str] = mapped_column(String(5), default="")
    duration: Mapped[int] = mapped_column(Integer, default=60); column_name: Mapped[str] = mapped_column(String(80), default="Запланировано")
