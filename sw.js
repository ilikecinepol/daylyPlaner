const CACHE='plan-v6.2';
const ASSETS=['/','/index.html','/styles.css?v=2.7','/app.js?v=6.2','/frontend/js/api.js','/frontend/js/profile.js','/frontend/js/goals.js','/manifest.webmanifest'];
