const CACHE='plan-v6.8';
const ASSETS=['/','/index.html','/styles.css?v=3.1','/app.js?v=6.8','/frontend/js/api.js','/frontend/js/profile.js','/frontend/js/goals.js','/frontend/js/ai.js','/manifest.webmanifest'];
